...
params = {
    'currency': 'USDJPY',
    'output_folder': 'outputs_using_ticks_5000_from_2005_rtx2070',
    'preprocessing': {
        'is_tick': True,
...
for obj in params['methodologies']:
    ...
    if obj['method'] == 'lstm-bert':
        ...
        train_df = df[df['Timestamp'] < parseISODateTime('2018-07-01T00:00:00')]
        validation_df = df[(df['Timestamp'] >= parseISODateTime('2018-07-01T00:00:00')) & (df['Timestamp'] < parseISODateTime('2019-01-01T00:00:00'))] # half year
        test_df = df[df['Timestamp'] >= parseISODateTime('2019-01-01T00:00:00')]
