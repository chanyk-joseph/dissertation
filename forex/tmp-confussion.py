...
conf_matrix = confusion_matrix(test['Target_Prediction'], y_pred)
sns.heatmap(conf_matrix,annot=True,fmt='3.0f',cmap="summer")
plt.title('Confusion_matrix', y=1.05, size=15)
plt.savefig(path.join(output_folder, 'random_forest_confusion_matrix_.png'), bbox_inches='tight')
