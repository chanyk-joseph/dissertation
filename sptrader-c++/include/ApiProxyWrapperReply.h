...
public:
	...
	virtual void OnAccountLogoutReply(char *accNo, long ret_code, char* ret_msg) = 0;
	...
	virtual void OnProductListByCodeReply(long req_id, char *inst_code, bool is_ready, char *ret_msg) = 0;
	virtual void OnInstrumentListReply(long req_id, bool is_ready, char *ret_msg) = 0;
