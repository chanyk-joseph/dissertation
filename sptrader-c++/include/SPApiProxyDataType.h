...
#define ONE_TIME_AUTHENTICATION  1
#define SECOND_PASSWORD          2

#define REMOVE_DEVICE_CURRENT   0
#define REMOVE_DEVICE_ALL       1
#define REMOVE_DEVICE_SPECIFIC  2
...
#define ERR_2FA_CHK_VALID           -30000000

#define ERR_2FA_INVALID_REQ         ERR_2FA_CHK_VALID - 0
#define ERR_2FA_WRONG_PSW           ERR_2FA_CHK_VALID - 1
#define ERR_2FA_TOO_MANY_WRONG_PSW  ERR_2FA_CHK_VALID - 2
#define ERR_2FA_EXPIRED             ERR_2FA_CHK_VALID - 3
