...
func GetHSIConstituentsCodes() ([]converter.StandardSymbol, error) {
	...
	result := []converter.StandardSymbol{}
	for _, match := range matches {
		result = append(result, converter.StandardSymbol{Symbol: match[1]})
	}
